...
We use the statistical programming language R [@citeR] with packages `tidyverse` [citeTidyverse], , `rstanarm` [@rstanarm], `modelsummary` [@citeModleSummary], `knitr` [@citeKnitr], `kableExtra` [@citeKableExtra], `tidybayes` [@tidybayes], and follow @tellingstories.
